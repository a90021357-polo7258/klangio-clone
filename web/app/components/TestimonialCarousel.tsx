...
const testimonials: Testimonial[] = [
    {
        quote: "30년 이상 현대 작곡과 기타와 베이스의 정통 연주 기법에 대한 기초 연구를 해온 저는 전문 표기법 소프트웨어에 대한 높은 기준을 가지고 있습니다. Melodify, 마침내 저와 저의 특정 용도에 가장 적합한 소프트웨어를 찾았고, 이를 통해 창의력을 자유롭게 발휘할 수 있게 되었습니다.",
        name: "얀 헤닝",
        title: "기타 마법사",
        credit: "사진: 엘렌 슈마우스"
    },
    {
        quote: "Melodify는 제 음악 작업 흐름을 완전히 바꿔놓았습니다. 이제 아이디어를 즉시 악보로 변환할 수 있어 창작 과정이 훨씬 빨라졌습니다.",
        name: "김민준",
        title: "작곡가 겸 프로듀서"
    },
    {
        quote: "학생들에게 음악을 가르칠 때 Melodify는 필수 도구가 되었습니다. 복잡한 곡도 쉽게 악보로 만들 수 있어 수업 준비 시간이 크게 줄었습니다.",
        name: "이서연",
        title: "음악 교사"
    },
    {
        quote: "피아니스트로서 YouTube에서 들은 곡을 연습하고 싶을 때가 많은데, Melodify 덕분에 이제 어떤 곡이든 악보로 만들 수 있습니다.",
        name: "박지훈",
        title: "피아니스트"
    }
]
